...
class Instrument1DTOFParameters(BaseObj):
    ...
    def __init__(self,
                 ...
                 dtt1: Parameter, dtt2: Parameter,
                 sigma0: Parameter, sigma1: Parameter, sigma2: Parameter,
                 gamma0: Parameter, gamma1: Parameter, gamma2: Parameter,
                 alpha0: Parameter, alpha1: Parameter,
                 beta0: Parameter, beta1: Parameter,
                 interface=None):
        super().__init__(self.__class__.__name__,
    ...
    def from_pars(cls,
        ...
        return cls(ttheta_bank=ttheta_bank,
                   dtt1=dtt1, dtt2=dtt2,
                   sigma0=sigma0, sigma1=sigma1, sigma2=sigma2,
                   gamma0=gamma0, gamma1=gamma1, gamma2=gamma2,
                   alpha0=alpha0, alpha1=alpha1,
...
Unpolarized1DTOFClasses = JobSetup([Powder1DSim, Powder1DExp],
                                Powder1DParameters,
