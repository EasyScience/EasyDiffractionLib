...
def calcObjAndDictToEdExperiments(cryspy_obj, cryspy_dict):
    # NEED to be modified similar to cryspyObjAndDictToEdModels -> cryspyObjToEdModels
    ...
    for data_block in cryspy_obj.items:
        ...
        if data_block_name in experiment_names:
            ...
            for item in cryspy_experiment:
                ...
                # Ranges category
                if type(item) is cryspy.C_item_loop_classes.cl_1_range.Range:
                    ...
                    # pd-tof ranges
                        ...
                        ed_experiment_no_meas['params']['_pd_meas']['tof_range_min'] = dict(
                            Parameter(
                                item.time_min,
                                optional=True,
                                category='_pd_meas',
                        ...
                        ed_experiment_no_meas['params']['_pd_meas']['tof_range_max'] = dict(
                            Parameter(
                                item.time_max,
                                optional=True,
                                category='_pd_meas',
                        ...
                        ed_experiment_no_meas['params']['_pd_meas']['tof_range_inc'] = dict(
                            Parameter(
            ...
            for item in cryspy_experiment:
                ...
                elif type(item) is cryspy.C_item_loop_classes.cl_1_setup.Setup:
                ...
                # sg-cwl
                    ...
                    if hasattr(item, 'model') and hasattr(item, 'mosaicity') and hasattr(item, 'radius'):
                        ...
                        ed_experiment_no_meas['params']['_extinction']['model'] = dict(
                            Parameter(
                                item.model,
                        ...
                        ed_experiment_no_meas['params']['_extinction']['mosaicity'] = dict(
                            Parameter(
                                item.mosaicity,
                        ...
                        ed_experiment_no_meas['params']['_extinction']['radius'] = dict(
                            Parameter(
                                item.radius,
                ...
                # Cryspy parameters section (TOF)
                    ...
                    if (
                        hasattr(item, 'zero')
                        and hasattr(item, 'dtt1')
                        and hasattr(item, 'dtt2')
                        and hasattr(item, 'ttheta_bank')
                    ):
                        if '_pd_instr' not in ed_experiment_no_meas['params']:
                            ed_experiment_no_meas['params']['_pd_instr'] = {}
                        ed_experiment_no_meas['params']['_pd_instr']['2theta_bank'] = dict(
                            Parameter(
                                item.ttheta_bank,
                                category='_pd_instr',
                                prettyCategory='inst',
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['dtt1'] = dict(
                            Parameter(
                                item.dtt1,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['dtt2'] = dict(
                            Parameter(
                                item.dtt2,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['zero'] = dict(
                            Parameter(
                                item.zero,
                ...
                # Cryspy peak profile section (TOF)
                    ...
                    if hasattr(item, 'alpha0') and hasattr(item, 'beta0') and hasattr(item, 'sigma0'):
                        if '_pd_instr' not in ed_experiment_no_meas['params']:
                            ed_experiment_no_meas['params']['_pd_instr'] = {}
                        ed_experiment_no_meas['params']['_pd_instr']['alpha0'] = dict(
                            Parameter(
                                item.alpha0,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['alpha1'] = dict(
                            Parameter(
                                item.alpha1,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['beta0'] = dict(
                            Parameter(
                                item.beta0,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['beta1'] = dict(
                            Parameter(
                                item.beta1,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['sigma0'] = dict(
                            Parameter(
                                item.sigma0,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['sigma1'] = dict(
                            Parameter(
                                item.sigma1,
                    ...
                    if hasattr(item, 'sigma2'):
                        if '_pd_instr' not in ed_experiment_no_meas['params']:
                            ed_experiment_no_meas['params']['_pd_instr'] = {}
                        ed_experiment_no_meas['params']['_pd_instr']['sigma2'] = dict(
                            Parameter(
                                item.sigma2,
                    ...
                    if hasattr(item, 'gamma0') and hasattr(item, 'gamma1') and hasattr(item, 'gamma2'):
                        if '_pd_instr' not in ed_experiment_no_meas['params']:
                            ed_experiment_no_meas['params']['_pd_instr'] = {}
                        ed_experiment_no_meas['params']['_pd_instr']['gamma0'] = dict(
                            Parameter(
                                item.gamma0,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['gamma1'] = dict(
                            Parameter(
                                item.gamma1,
                        ...
                        ed_experiment_no_meas['params']['_pd_instr']['gamma2'] = dict(
                            Parameter(
                                item.gamma2,
                ...
                # Cryspy background section (TOF, polinom coeffs)
                    ...
                    if hasattr(item, 'time_max'):
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['time_max'] = dict(
                            Parameter(
                                item.time_max,
                                optional=True,
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff1'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff2'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff3'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff4'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff5'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff6'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff7'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff8'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff9'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff10'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff11'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff12'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff13'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff14'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff15'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff16'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff17'] = dict(
                            Parameter(
                        ...
                        ed_experiment_no_meas['params']['_tof_background']['coeff18'] = dict(
                            Parameter(
                ...
                # Cryspy measured data section: pd-tof
                    ...
                    if '_diffrn_radiation' not in ed_experiment_no_meas['params']:
                        ed_experiment_no_meas['params']['_diffrn_radiation'] = {}
                    ed_experiment_no_meas['params']['_diffrn_radiation']['type'] = dict(
                        Parameter(
                            'tof',
                            optional=True,
                            category='_diffrn_radiation',
                    ...
                    ed_experiment_no_meas['params']['_sample']['type'] = dict(
                        Parameter(
                            'pd',
                            optional=True,
                            category='_sample',
                    ...
                    for idx, cryspy_meas_point in enumerate(cryspy_meas_points):
                        ed_meas_point = {}
                        ed_meas_point['time_of_flight'] = dict(
                            Parameter(
