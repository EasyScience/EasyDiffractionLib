...
def pattern_from_cif_block(block) -> dict:
    ...
    value = (block.find_value("_diffrn_radiation_polarization")
             or block.find_value("_diffrn_radiation.polarization"))
    if value is not None:
        pattern['beam.polarization'] = float(value)
    value = (block.find_value("_diffrn_radiation_efficiency")
             or block.find_value("_diffrn_radiation.efficiency"))
    if value is not None:
    ...
    value = (block.find_value("_setup_offset_2theta")
             ...
             or value_from_loop_by_another_column(block,
                                                  category="_pd_calib_d_to_tof",
                                                  desired_column="coeff",
                                                  another_column="power",
                                                  another_value="0")
             )
    if value is not None:
        pattern['zero_shift'] = {}
    ...
    value = (block.find_value("_setup_field")
             or block.find_value("_setup.field"))
    if value is not None:
        pattern['field'] = float(value)
    value = (block.find_value("_diffrn_radiation_probe")
             or block.find_value("_diffrn_radiation.probe"))
    if value is not None:
...
def parameters_from_cif_block(block) -> dict:
    ...
    value = (block.find_value("_pd_instr_resolution_u")
             or block.find_value("_pd_instr.resolution_u"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_resolution_v")
             or block.find_value("_pd_instr.resolution_v"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_resolution_w")
             or block.find_value("_pd_instr.resolution_w"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_resolution_x")
             or block.find_value("_pd_instr.resolution_x"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_resolution_y")
             or block.find_value("_pd_instr.resolution_y"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_reflex_asymmetry_p1")
             or block.find_value("_pd_instr.reflex_asymmetry_p1"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_reflex_asymmetry_p2")
             or block.find_value("_pd_instr.reflex_asymmetry_p2"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_reflex_asymmetry_p3")
             or block.find_value("_pd_instr.reflex_asymmetry_p3"))
    if value is not None:
    ...
    value = (block.find_value("_pd_instr_reflex_asymmetry_p4")
             or block.find_value("_pd_instr.reflex_asymmetry_p4"))
    if value is not None:
        parameters['reflex_asymmetry_p3'] = {}
        parameters['reflex_asymmetry_p3']['value'], parameters['reflex_asymmetry_p3']['error'] = parse_with_error(value)

    # ToF
    value = (block.find_value("_pd_instr_dtt1")
    ...
    value = (block.find_value("_pd_instr_dtt2")
    ...
    value = (block.find_value("_pd_instr_2theta_bank")
             or block.find_value("_pd_instr.2theta_bank"))
    if value is not None:
        parameters['2theta_bank'] = {}
        parameters['2theta_bank']['value'], parameters['2theta_bank']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_peak_shape")
             or block.find_value("_pd_instr.peak_shape"))
    if value is not None:
        parameters['peak_shape'] = value
    value = (block.find_value("_pd_instr_alpha0")
             or block.find_value("_pd_instr.alpha0"))
    if value is not None:
        parameters['alpha0'] = {}
        parameters['alpha0']['value'], parameters['alpha0']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_alpha1")
             or block.find_value("_pd_instr.alpha1"))
    if value is not None:
        parameters['alpha1'] = {}
        parameters['alpha1']['value'], parameters['alpha1']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_beta0")
             or block.find_value("_pd_instr.beta0"))
    if value is not None:
        parameters['beta0'] = {}
        parameters['beta0']['value'], parameters['beta0']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_beta1")
             or block.find_value("_pd_instr.beta1"))
    if value is not None:
        parameters['beta1'] = {}
        parameters['beta1']['value'], parameters['beta1']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_gamma0")
             or block.find_value("_pd_instr.gamma0"))
    if value is not None:
        parameters['gamma0'] = {}
        parameters['gamma0']['value'], parameters['gamma0']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_gamma1")
             or block.find_value("_pd_instr.gamma1"))
    if value is not None:
        parameters['gamma1'] = {}
        parameters['gamma1']['value'], parameters['gamma1']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_gamma2")
             or block.find_value("_pd_instr.gamma2"))
    if value is not None:
        parameters['gamma2'] = {}
        parameters['gamma2']['value'], parameters['gamma2']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_sigma0")
             or block.find_value("_pd_instr.sigma0"))
    if value is not None:
        parameters['sigma0'] = {}
        parameters['sigma0']['value'], parameters['sigma0']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_sigma1")
             or block.find_value("_pd_instr.sigma1"))
    if value is not None:
        parameters['sigma1'] = {}
        parameters['sigma1']['value'], parameters['sigma1']['error'] = parse_with_error(value)
    value = (block.find_value("_pd_instr_sigma2")
             or block.find_value("_pd_instr.sigma2"))
    if value is not None:
        parameters['sigma2'] = {}
